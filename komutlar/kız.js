...
exports.run = async (client, message, args) => {
...

 {
  ...
  if(!isimler) {
          ...
          .setDescription("<a:alastra_tik:814576897567752203> <@"+member+"> üyesi başarıyla kız olarak kayıt edildi.")
          .setColor("RANDOM")
